                                  ...
                                  <tr className="odd">
                                    ...
                                    <td>
                                      ...
                                      <ion-icon
                                        ...
                                        title="Delete"
                                      ></ion-icon>
                                      <ion-icon name="print-outline" color="secondary" style={{ marginRight: "10px" }} title="Print"></ion-icon>
                                     
                                      <ion-icon name="mail-outline" color="tertiary" style={{ marginRight: "10px" }} title="Email"></ion-icon>
                                      <ion-icon
                                        name="create-outline"
                                        color="primary"
                                        style={{ marginRight: "10px" }}
                                        title="Edit"
                                      ></ion-icon>
                                      <ion-icon name="checkbox-outline" color="success" style={{ marginRight: "10px" }}  title="Approve"></ion-icon>
                                    </td>
                                  </tr>
