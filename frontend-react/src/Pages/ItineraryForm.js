...
const ItineraryForm = ({ onValidationStatusChange }) => {
    ...
    if (quotFormData) {
      ...
      for (let index = 0; index < quotItineraryData.length; index++) {
        quotItineraryArray.push({
          ...
          quotItiAmount: quotItineraryData[index].quotItiAmount ? quotItineraryData[index].quotItiAmount : 0,
        });
      }
  ...
  useEffect(() => {
    ...
    if (tourItiDescription.length>0){
      setSelectedLocationDescription(tourItiDescription[0].tourItiDescription ? tourItiDescription[0].tourItiDescription:"");
                      ...
                      >
                        <thead>
                          <tr>
                            ...
                            <th style={{ width: "116.672px" }}>Amount</th>
                          ...
                          {itineraryData &&
                            ...
                            itineraryData.map((itineraryObj, index) => (
                              <tr className="odd" key={index}>
                                ...
                                <td>{itineraryObj.quotItiDate ?itineraryObj.quotItiDate.split('T')[0]:"N.A" }</td>
